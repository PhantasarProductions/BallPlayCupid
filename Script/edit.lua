...
mkl.version("BallPlay Cupid - edit.lua","16.04.14")
mkl.lic    ("BallPlay Cupid - edit.lua","GNU General Public License 3")


quickmath = quickmath or j_love_import("Libs/quickmath.lua")	-- *import quickmath
save = save or j_love_import("Libs/save.lll/save.lua")	-- *import save

-- The functions tied to the objects will all be nil, but in the editor that doesn't matter anyway.
drawgamescreen = drawgamescreen or j_love_import("SCRIPT/GAME.LLL/drawgamescreen.lua")	-- *import GAME.LLL/drawgamescreen
